...
node* panclub::create()
{
    node *temp,*n1;
    temp=n1=NULL;
    cout<<"enter the no of members in group";
    cin>>cnt;
    do
    {
        n1=new node;
...
int main()
{
   ...
   do
   {
    cout<<"\n\n1.Enter data of group1";
    cout<<"\n2.Enter data of group2:";
    ...
    switch(ch)
    {
     case 1:
            ...
            cout<<"\n\nEnter the Panclub Data of group1:\n";
            h1=p1.create();
        cout<<"\nList are as follows..\n\n";
        p1.display(h1);
        cout<<"\n\nReverse List :\n\n";
        ...
        break;
    case 2:
        cout<<"\n\nEnter the club Data of group 2\n";
        h2=p2.create();
        cout<<"\n List are as follows..\n\n";
        p2.display(h2);
        cout<<"\n\nReverse List :\n\n";
    ...
    case 3:
        h3=p3.concat(h1,h2);
        cout<<"\n\nThe concatenation of group1 and 2 is.\n\n";
        p3.display(h3);
            break;
  }
 }while(ch!=4);
